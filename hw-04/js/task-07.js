...
const account = {
  ...
  deposit(amount) {
    this.balance += amount;
    const newTransaction = this.createTransaction(amount, 'deposit', 'id-01');
   ...
   */
  withdraw(amount) {
    const newTransaction = this.createTransaction(amount, 'withdraw', 'id-02');
    this.transactions.push(newTransaction);
...
console.table(account.deposit(1000));
console.table(account.deposit(5000));
console.table(account.withdraw(1000));
console.table(account.withdraw(2000));
